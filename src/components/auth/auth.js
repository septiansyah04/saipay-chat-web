...
export default class Auth extends Component {
  ...
  render() {
    ...
    const authText = isLogin ? "Belum punya akun Saipay ?" : 'Sudah punya akun Saipay?'
    const authLink = isLogin ? 'Daftar' : 'Masuk'
        ...
        <div className="auth-modal-container" style={isLogin ? { height: '500px' } : { height: '570px' }}>
          ...
          <form onSubmit={this.login} className="auth-form auth-wrapper">
            ...
            <input
              ...
              name="Password" />
            <button type="submit" value="Submit">{isLogin ? 'Masuk' : 'Daftar'}</button>
          </form>

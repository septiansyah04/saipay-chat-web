        ...
        <div className="create-dialog-body">
          ...
          <div className="create-dialog-body-type-dialog">
            <button onClick={this.changeTypeDialog}>
              {dialogType ? <FontAwesomeIcon icon={faUsers} color={'#4E8FC9'} /> :
                <FontAwesomeIcon icon={faUser} color={'#4E8FC9'} />
              }
              <span>{dialogType ? `Buat Pesan Private` : `Buat Pesan Grup`}</span>
            </button>
          </div>
          ...
          {this.selectedUsers.length > 0 &&
            <div className="create-dialog-body-btn">
              <button onClick={this.createDialog}>Buat Grup Chat</button>
            </div>
          }
        </div>
      </div>
